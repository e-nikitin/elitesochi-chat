const chat = {
  async open(self){
    ...
    chat.setBlur(true, document.getElementsByClassName('object-tabset tabset')[0], 10)
    ...
    if(self.$refs.messages) self.$refs.messages.scrollTop = self.$refs.messages.scrollHeight
    if(self.$refs.messages) self.$refs.messages.addEventListener('scroll', function(){
  ...
  close(self){
    ...
    chat.setBlur(false, document.getElementsByClassName('object-tabset tabset')[0], 10)
